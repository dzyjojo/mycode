...
def usage(return_code=2):
    help = """
Usage %s --name "zhiyang" --mail "zhiyang@staff.sina.com.cn" --mobile "186xxxxxxxx" --ivr "xxxx" [options]
 ...
 options:
  ...
  --name            contactor
  --mail            mail address
  --mobile          Receive SMS mobile phone number
  --ivr             Telephone alarm
...
if __name__ == "__main__":
    ...
    data = dict(
        kid = '2636703830',
        passwd = 'lAkqmaX9ZTcUrmLFwv15zyQBg6FAti',
        #url = 'http://connect.monitor.sina.com.cn/v1/alert/send',
        # For neiwang
        url = 'http://iconnect.monitor.sina.com.cn/v1/contact/new',
        name = None,
        mail = None,
        mobile = '',
        ivr = '',
    ...
    #client.post('v1/contact/new', {'name':'test', 'mail':'zhiyang@staff.sina.com.cn'})
